...
ALTER TYPE public.account_type
    OWNER TO cse340dbguzman;

-- Drop existing classification table if it exists
...
CREATE TABLE public.classification(
    ...
    classification_approved BOOLEAN NOT NULL DEFAULT FALSE,
    CONSTRAINT classification_pk PRIMARY KEY (classification_id)
);

-- Insert classification data
INSERT INTO public.classification (classification_name, classification_approved)
VALUES ('Custom', TRUE),
    ('Sport', TRUE),
    ('SUV', TRUE),
    ('Truck', TRUE),
...
CREATE TABLE IF NOT EXISTS public.account (
    ...
    account_type INTEGER NOT NULL REFERENCES public.account_type(type_id) DEFAULT 1
);
